...
- **System One decisions** — `/v1/systemone` serves typed decision models like Laya and CLM.
...
<CardGroup cols={2}>
  ...
  <Card title="System One" icon="bolt" href="/cloud/grid/system-one">Typed decision models like Laya and CLM.</Card>
