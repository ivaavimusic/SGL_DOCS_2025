...
|---|---|---|---|
| Node.js | `npm install x402sgl` | [Singularity-SDK](https://github.com/ivaavimusic/Singularity-SDK) | [Singularity-SDK](https://github.com/ivaavimusic/Singularity-SDK) |
| Python | `pip install git+https://github.com/ivaavimusic/Singularity-SDK.git#subdirectory=python` | [Singularity-SDK](https://github.com/ivaavimusic/Singularity-SDK) | [Singularity-SDK](https://github.com/ivaavimusic/Singularity-SDK) |
