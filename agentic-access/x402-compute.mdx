...
<Note>
  Current release: **v1.2.0**. This release keeps x402 Base/Solana payments live and adds MPP support for agent/CLI payments on Tempo mainnet USDC.e. Stripe card payments are code-ready and will be enabled after Stripe Machine Payments / Shared Payment Token access is approved.
</Note>
