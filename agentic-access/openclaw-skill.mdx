...
<Note>
  Current release: **v1.9.0**. This release adds optional Singularity MCP control-plane guidance so agents can use a dashboard PAT for owner-scoped management without making PAT setup globally required.
</Note>
