...
<Note>
  Current release: **v1.5.0**. The skill now packages a full payments integration path for agents, and the bundled Solana signer matches the live PayAI-backed compute limit requirements.
</Note>
