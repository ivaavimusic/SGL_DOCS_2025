...
<Note>
  Current release: **v1.7.0**. The skill now includes wallet-signed support APIs, support thread commands, XMTP helper flows, and AgentKit-aware discovery and payment.
</Note>
