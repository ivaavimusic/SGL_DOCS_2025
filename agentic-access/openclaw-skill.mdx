...
<Note>
  Current release: **v1.8.1**. This patch fixes direct Base skill payments by rejecting self-payment clearly and aligning the payment URL shape with the hosted pay flow.
</Note>
