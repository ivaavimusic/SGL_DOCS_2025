...
<Note>
  Current release: **v1.8.2**. This patch removes globally-required secret env declarations from the skill metadata and switches the docs to capability-specific environment guidance.
</Note>
